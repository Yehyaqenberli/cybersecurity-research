...
The security research published in this repository was conducted under the following responsible disclosure principles:

### 1. Minimize Harm

- Use the least invasive technique that confirms the vulnerability.
- Prefer read-only operations over writes.
- Use safe test parameters or researcher-controlled identifiers for proof-of-concept demonstrations whenever possible.
...
- If personal identifiers are discovered, do not contact the individuals.
...
- Disclose the records accessed.

### 4. Honest Scoring and Scope

- Compute severity scores from standardized vectors, not from subjective estimation.
